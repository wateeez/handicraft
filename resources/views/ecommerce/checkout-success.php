...
// Get order details
$order = \Illuminate\Support\Facades\DB::table('orders')->where('order_number', $orderNumber)->first();
...
\Illuminate\Support\Facades\Session::forget('order_number');
?>
    ...
    <div class="container">
        ...
        <div class="order-details-card">
            ...
            <div class="order-totals">
                <div class="total-row">
                    <span>Subtotal:</span>
                    <span><?php echo formatPrice($order->subtotal ?? 0); ?></span>
                </div>
                <div class="total-row">
                    <span>Shipping:</span>
